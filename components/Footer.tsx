        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
            ...
            <div className="md:col-span-1">
                ...
                <div className="flex gap-4">
                    <a href="https://www.instagram.com/catbear_artstudio?igsh=eG1pYzk5N3F1cWEw&utm_source=qr" target="_blank" rel="noopener noreferrer" className="w-11 h-11 rounded-full bg-[#FFCDE4] border-4 border-white shadow-lg flex items-center justify-center hover:scale-110 transition-all text-[#4D96AD]" title="Instagram">
                    ...
                    <a href="https://www.tiktok.com/@catbear.artstudio?_r=1&_t=ZS-94YzP2AaqgB" target="_blank" rel="noopener noreferrer" className="w-11 h-11 rounded-full bg-[#FFCDE4] border-4 border-white shadow-lg flex items-center justify-center hover:scale-110 transition-all text-[#4D96AD]" title="TikTok">
                        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                                ...
                                <li key={link.label}>
                                    {'icon' in link ? (
                                        <a href={link.href} className="flex items-center gap-4 group">
                                            <div className="w-10 h-10 rounded-full bg-[#FFCDE4] border-4 border-white shadow-lg flex items-center justify-center text-sm group-hover:scale-110 transition-all flex-shrink-0">
                                                {link.icon}
                                            </div>
