...
const GalleryNavbar = () => {
    return (
        <header className="fixed top-0 left-0 w-full z-50 transition-all duration-300">
            {/* Topbar - same style as main navbar */}
            ...
            {/* Main Navbar - Specialized for Gallery */}
            <div className="mx-6 md:mx-20 mt-4 h-20 bg-white rounded-full shadow-lg border border-gray-100 flex items-center justify-between px-8">
                {/* Left side: Logo + Back button */}
                <div className="flex items-center gap-6">
                    <Link href="/" className="flex items-center gap-2 hover:opacity-80 transition-opacity" title="Back to Home">
                ...
                <div className="flex-1 flex justify-center">
                    <h2 className="text-lg md:text-xl font-black text-[#4D96AD] tracking-tight whitespace-nowrap">
                        Our Student <span className="text-pink-500 underline decoration-pink-200 underline-offset-4">Gallery</span>
                    </h2>
                </div>

                {/* Right side: Empty or simplified element to keep centering */}
                <div className="w-[140px] hidden md:flex justify-end">
                    {/* Keep balance, maybe a small decorative element or just empty */}
